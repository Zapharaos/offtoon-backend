...
// Source: https://github.com/leosunmo/zapchi
...
// zapChiLogger is a Chi middleware that logs each request recived using
// the provided Zap logger, sugared or not.
// Provide a name if you want to set the caller (`.Named()`)
// otherwise leave blank.
func zapChiLogger(l interface{}, name string) func(next http.Handler) http.Handler {
	...
	default:
		// Log error and exit
		log.Fatalf("Unknown logger passed in. Please provide *Zap.zapChiLogger or *Zap.SugaredLogger")
	}
	return nil
}
